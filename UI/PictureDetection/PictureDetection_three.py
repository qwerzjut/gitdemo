...
from UI.PictureDetection.PictureDetectionWin_three import PictureDetectionWin_three
from model.QclickableImage import QClickableImage
from PyQt5.QtCore import QThread, pyqtSignal


class PictureDetection_three(PictureDetectionWin_three):
    def __init__(self,configuration):
        super(PictureDetection_three, self).__init__()
        self.setupUi(self)
