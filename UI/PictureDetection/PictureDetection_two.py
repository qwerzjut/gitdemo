...
from UI.PictureDetection.PictureDetectionWin_two import PictureDetectionWin_two
from model.QclickableImage import QClickableImage
from PyQt5.QtCore import QThread, pyqtSignal


class PictureDetection_two(PictureDetectionWin_two):
    def __init__(self,configuration):
        super(PictureDetection_two, self).__init__()
        self.setupUi(self)
