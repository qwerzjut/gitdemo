...
from UI.PictureDetection.PictureDetectionWin_one import PictureDetectionWin_one
from model.QclickableImage import QClickableImage
from PyQt5.QtCore import QThread, pyqtSignal


class PictureDetection_one(PictureDetectionWin_one):
    def __init__(self,configuration):
        super(PictureDetection_one, self).__init__()
        self.setupUi(self)
