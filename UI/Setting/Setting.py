...
#        self.fps_value_label.setText("23.4")
        if not os.path.exists('../config.ini'):
             #self.epoch_lable_value.setText("1000")
            ...
            #self.ho_lable_value.setValue(self.configuration.value("EPOCH"))
...
#            self.th1_spinBox.setValue(float(self.cannyth))
#             self.th2_spinBox.setValue(int(self.zzth))
    ...
    def saveSetting(self):
        ...
        self.configuration.setValue("EPOCH",self.ex_lable_value.text())
        self.configuration.setValue("BATCHSIZE",self.dl_lable_value.text())
        ...
        self.configuration.setValue("EPOCHS",self.gn_lable_value.text())
